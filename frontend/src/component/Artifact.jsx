...
import { PanelRightClose, Code2, PanelRightOpen, Eye, Copy, Check, X } from "lucide-react";
              ...
              >
                ...
                >
                  <Editor
                    ...
                    value={files.content}
                    options={{
                      readOnly: true, minimap: { enabled: false }, fontSize: 13, lineHeight: 20, fontSize: 13, wordWrap: "on", scrollBeyondLastLine: false, automaticLayout: true,
 ...
 return (
  <>
    ...
    <button
      ...
      className={`lg:hidden fixed bottom-24 right-4 flex items-center gap-2 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-[12px] font-medium shadow-lg shadow-indigo-500/20 border-none cursor-pointer transition-all duration-150 ${
        mobileOpen ? 'z-0 opacity-0 pointer-events-none' : 'z-50 opacity-100 pointer-events-auto'
      }`}
    >
      <Code2 size={13} />
      View Code
      ...
      {mobileOpen && (
        ...
        >
          <motion.div
            ...
            className="lg:hidden fixed inset-y-0 right-0 z-[101] w-[88vw] max-w-[420px] border border-white/[0.06] overflow-hidden bg-[#0d0f14]"
